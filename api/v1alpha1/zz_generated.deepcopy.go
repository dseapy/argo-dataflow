...
func (in *AbstractVolumeSource) DeepCopy() *AbstractVolumeSource {
	if in == nil {
		return nil
	}
	out := new(AbstractVolumeSource)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Cat) DeepCopyInto(out *Cat) {
	*out = *in
	in.AbstractStep.DeepCopyInto(&out.AbstractStep)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConfluentSchemaRegistryConfig) DeepCopyInto(out *ConfluentSchemaRegistryConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfluentSchemaRegistryConfig.
func (in *ConfluentSchemaRegistryConfig) DeepCopy() *ConfluentSchemaRegistryConfig {
	if in == nil {
		return nil
	}
	out := new(ConfluentSchemaRegistryConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Kafka) DeepCopyInto(out *Kafka) {
	*out = *in
	...
	if in.ConfluentSchemaRegistryConfig != nil {
		in, out := &in.ConfluentSchemaRegistryConfig, &out.ConfluentSchemaRegistryConfig
		*out = new(ConfluentSchemaRegistryConfig)
		**out = **in
	}
}
...
func (in *KafkaSource) DeepCopyInto(out *KafkaSource) {
	*out = *in
	in.Kafka.DeepCopyInto(&out.Kafka)
	if in.FetchMin != nil {
		in, out := &in.FetchMin, &out.FetchMin
		x := (*in).DeepCopy()
		*out = &x
	}
	if in.FetchWaitMax != nil {
		in, out := &in.FetchWaitMax, &out.FetchWaitMax
		*out = new(metav1.Duration)
		**out = **in
	}
}
...
func (in *VolumeSink) DeepCopyInto(out *VolumeSink) {
	*out = *in
	in.AbstractVolumeSource.DeepCopyInto(&out.AbstractVolumeSource)
}
